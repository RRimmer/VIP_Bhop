...
Модифицированная версия VIP BHOP с циклом включения/отключения, уведомлениями и отдельным конфигом. Подходит для серверов CSGO на SourceMod.
...
Сравнительное видео будет склеено в одно.
